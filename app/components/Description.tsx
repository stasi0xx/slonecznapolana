...
const cards = [
  {
    ...
    note: "Cisza i spokój przez cały rok",
    rotate: "-1.8deg",
  },
  {
    image: "/images/fota.jpg",
    caption: "Prywatna sauna fińska",
    note: "Opałana drewnem, tylko dla Was",
    rotate: "2.2deg",
  },
  {
    image: "/images/inside/foto1.jpg",
    caption: "Wnętrze z charakterem",
    note: "Każdy detal przemyślany",
    rotate: "-1.1deg",
  },
  {
    image: "/images/fota2.jpg",
    caption: "Kominek na wieczory",
    note: "Gdy za oknem sypie śnieg",
    rotate: "2.8deg",
  },
  {
    image: "/images/inside/foto2.jpg",
    caption: "Przestronna kuchnia",
    note: "Pełne wyposażenie, ekspres, zmywarka",
    rotate: "-2.4deg",
  },
  {
    image: "/images/fota3jpg.webp",
    caption: "Jezioro 450 m stąd",
    note: "Mazury na wyciągnięcie ręki",
    rotate: "1.5deg",
  },
  {
  ...
  {
    image: "/images/fota4jpg.webp",
    caption: "30 m² tarasu",
    note: "Śniadanie przy kawie, bez pośpiechu",
    rotate: "2.1deg",
  },
  {
    image: "/images/inside/foto4.jpg",
    caption: "Salon",
    note: "Do 12 osób — idealne na eventy",
    rotate: "-1.3deg",
  },
  {
